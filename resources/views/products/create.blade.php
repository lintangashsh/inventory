        ...
        <form action="{{ route('products.store') }}" method="POST" class="bg-white p-6 rounded shadow-md max-w-xl mx-auto"
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name"
                    class="w-full border border-pale px-4 py-2 rounded-xl focus:outline-none focus:ring focus:border-ocean"
            ...
            <button type="submit"
                class="w-full bg-blue-700 text-white font-semibold px-6 py-2 rounded hover:bg-blue-800 transition-all">
                Simpan Produk
            </button>
        </form>
    </div>
